...
import { CheckCircle, ShoppingBag, MapPin, CreditCard, Clock, Package, Truck, Calendar, ArrowRight, Printer } from 'lucide-react';
...
const OrderConfirmation = () => {
    ...
    useEffect(() => {
        const fetchOrder = async () => {
            ...
            try {
                ...
                // Based on standard API structure in this project:
    ...
    // Estimated delivery (random +3 days for demo)
    ...
    const currentStepIndex = steps.findIndex(s => s.status === order.status) !== -1
        ...
        : 0; // Default to 0 if status not found (e.g. 'cancelled' might be handled differently)
            ...
            <div className="bg-gray-50 min-h-screen py-12 px-4 sm:px-6 lg:px-8">
                <div className="max-w-4xl mx-auto">
                    ...
                    <div className="text-center mb-12">
                        ...
                        >
                            Thank you for your purchase. Your order <span className="font-bold text-gray-900">#{order.id}</span> has been received.
                        </motion.p>
                    </div>
                                    ...
                                    {order.orderItems.map((item) => (
                                        <div key={item.id} className="py-4 flex gap-4 items-center">
                                            <div className="w-16 h-16 bg-gray-100 rounded-lg overflow-hidden flex-shrink-0 border border-gray-200">
                                                {/* Placeholder for product image integration */}
