                        ...
                        <div className="space-y-4">
                            {orders.map((order, index) => (
                                <motion.div
                                    ...
                                    className="bg-white rounded-xl shadow-sm border border-slate-100 hover:shadow-md transition-shadow duration-200 overflow-hidden cursor-pointer group"
                                    ...
                                    <div className="p-6 flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                                        <div className="flex-1">
                                            ...
                                            <div className="flex flex-wrap gap-x-6 gap-y-2 text-sm text-slate-500">
                                                ...
                                                <div className="flex items-center gap-1.5">
                                                    <span className="font-medium text-slate-900">Rs. {order.total}</span>
                                                </div>
                                            </div>
                                        </div>
