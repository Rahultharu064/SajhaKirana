...
paymentRoutes.post("/:orderId/esewa/initiate",
  initiateEsewaPayment
);

// Khalti payment routes
paymentRoutes.post("/:orderId/khalti/initiate",
  initiateKhaltiPayment
);
...
paymentRoutes.get("/:orderId/status",
  authMiddleware,
  getPaymentStatus
);

// Admin: Update payment status
paymentRoutes.put("/status",
  authMiddleware,
  validate(paymentStatusSchema, "body"),
  updatePaymentStatus
);
