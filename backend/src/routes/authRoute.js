...
import { registerUser, loginUser, logoutUser, getCurrentUser, updateProfile, forgetPassword, resetPassword, verifyEmail, sendVerificationEmail, loginAdmin, createAdmin, } from "../controllers/authController";
import { validate } from "../middlewares/validate";
import { authMiddleware } from "../middlewares/authMiddleware";
import { uploadProfiles } from "../config/multer";
import { registerSchema, loginSchema, passwordResetSchema, resetPasswordSchema, verifyEmailSchema, } from "../validators/authValidator";
