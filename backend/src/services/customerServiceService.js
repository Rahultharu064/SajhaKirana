...
class CustomerServiceManager {
     ...
     */
    async createEscalationTicket(sessionId, userId, message, sentiment) {
...
Be brief and highlight the main issue.`;
     ...
     */
    generateEscalationResponse(ticket) {
        const priorityEmoji = {
            urgent: '🚨',
            high: '⚡',
            medium: '📞',
...
Your feedback helps us improve. 🙏`;
     ...
     */
    async processSatisfactionRating(rating, sessionId, userId) {
        try {
     ...
     */
    async getActiveTickets(limit = 20) {
        try {
...
//# sourceMappingURL=customerServiceService.js.map