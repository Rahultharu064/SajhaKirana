...
export class RecommendationService {
    ...
    async getUserPreferences(userId) {
        try {
            ...
            const prices = orders.flatMap((o) => o.orderItems.map((i) => i.product.price * i.quantity));
    ...
    async recommendProducts(userId, limit = 10) {
        try {
    ...
    async getBudgetProducts(maxPrice, limit = 10) {
        try {
